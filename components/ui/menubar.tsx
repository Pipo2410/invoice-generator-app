...
>(({ className, children, icon = true, ...props }, ref) => (
	<MenubarPrimitive.Trigger
		ref={ref}
		className={cn(
			'group inline-flex cursor-pointer select-none items-center px-3 py-1.5 text-sm font-medium outline-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground data-[state=open]:rounded-lg',
			className
		)}
		{...props}
	>
